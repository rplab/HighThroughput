...
classdef htInstrument < htForm
    properties
        iSuccessfulConnection % If 1, successful connection. If 0, no instrument was found but user wants to continue. If -1, no instrument was found and user wants to quit.
