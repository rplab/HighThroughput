		...
		if kb.kbhit():
			try:
				...
				#<< width alpha keys Inputs
					...
					writeup_location(scan[0], focus[0], stepSize, extent) #SetWidth) #sys.stdout.write(' \roffset = %5.3f, focus = %5.3f   |step size = %5.3f     |' % (scan[0], focus[0], stepSize))
